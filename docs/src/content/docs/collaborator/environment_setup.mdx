...
description: Setting up the environment for contributing to Saturn.
---
...
Install the required system packages for building and running Saturn:
...
Saturn supports **Claude Code** AI integration for code generation and assistance. To install it run the following Bash command:
