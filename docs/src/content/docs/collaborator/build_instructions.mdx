...
description: Instructions for building Mosaic from source.
---

import { Steps } from '@astrojs/starlight/components'

This document provides step-by-step instructions for building the Mosaic engine and editor from source code.
