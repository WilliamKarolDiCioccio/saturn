---
title: PIMPL Idiom
description: How Mosaic uses the PIMPL (Pointer to Implementation) idiom for interface stability and dependency isolation.
---

The **PIMPL idiom** (Pointer to IMPLementation) is used in Mosaic to enforce a strict separation between **public interfaces** and **private implementation details**.
...
Mosaic distinguishes between two forms of the PIMPL idiom, based on where behavior is implemented.
...
This is the **default and preferred approach** in Mosaic.
...
In Mosaic, PIMPL is not used for abstraction alone. It is a tool for enforcing architectural boundaries and preserving long-term maintainability.

---

## Design Guidance

When using PIMPL in Mosaic:
