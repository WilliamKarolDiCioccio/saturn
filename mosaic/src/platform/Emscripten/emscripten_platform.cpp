...
std::optional<bool> EmscriptenPlatform::showQuestionDialog(const std::string& _title,
...
void EmscriptenPlatform::showInfoDialog(const std::string& _title,
...
void EmscriptenPlatform::showWarningDialog(const std::string& _title,
                                           const std::string& _message) const
{
    EM_ASM(
        {
...
void EmscriptenPlatform::showErrorDialog(const std::string& _title,
                                         const std::string& _message) const
{
    EM_ASM(
        {
