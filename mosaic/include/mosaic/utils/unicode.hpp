...
#include <utf8.h> // or <utf8cpp/utf8.h> depending on how you include it
 ...
 */
inline std::vector<char32_t> Utf8ToCodepoints(const std::string& utf8)
{
 ...
 */
inline std::string CodepointsToUtf8(const std::vector<char32_t>& codepoints)
{
    std::string utf8;
