...
class Parser
{
   ...
   private:
    ...
    void parseArrayDeclarators(const TSNode& _node, std::vector<TypeDeclarator>& _out);
    ...
    std::shared_ptr<VariableNode> tryParsePointerToArrayVariable(const TSNode& _node);
